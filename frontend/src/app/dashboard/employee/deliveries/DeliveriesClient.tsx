...
//   useEffect(() => {
//     console.log("⚙️ Ongoing Trips:", ongoingTrips);
//     console.log("📦 Recent Trips:", recentTrips);
//   }, [ongoingTrips, recentTrips]);
...
//                       {trip.addresses?.length > 0 && (
//                         <div className="mt-2">
//                           <p className="text-sm font-semibold text-white underline">All Drops:</p>
...
//                                 .map((part) => part.trim())
//                                 .join(", ")}{" "}
//                               - {trip.completed?.[index] ? "✓ Done" : "✗ Not Done"}
//                             </p>
//                           ))}
//                         </div>
//                       )}
